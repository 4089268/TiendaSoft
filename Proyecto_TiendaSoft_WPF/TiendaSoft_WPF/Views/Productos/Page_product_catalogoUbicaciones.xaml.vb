...
Class Page_product_catalogoUbicaciones
    ...
    Private Sub cargarDatos()
        If (Mi_conexion.Conectar) Then
            ...
            SqlComand.CommandText = "Exec [Global].[Sys_Ubicaciones] @cAlias = 'CARGAR_CATALOGO'"
    ...
    Private Sub DataGrid1_selection(sender As Object, e As RoutedEventArgs) Handles DataGrid1.SelectionChanged
        Try
            ...
            cb_activo.IsChecked = Not CType(dataRow.Item("inactivo"), Boolean)
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Sub guardarCambios()
        If (tb_nombre.Text <> "") Then
            If (Mi_conexion.Conectar) Then
                ...
                SqlComand.CommandText = "[Global].[Sys_Ubicaciones]"
                ...
                Else
                    ...
                    SqlComand.Parameters.Add(New SqlClient.SqlParameter("@cId", DataGrid1.SelectedItem.Row.item("id")))
                End If

                SqlComand.Parameters.Add(New SqlClient.SqlParameter("@cDescripcion", tb_nombre.Text))
                SqlComand.Parameters.Add(New SqlClient.SqlParameter("@cInActivo", Not cb_activo.IsChecked))
